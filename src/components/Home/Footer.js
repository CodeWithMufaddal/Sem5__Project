         ...
         <div className="Footer"   >
            ...
            <div className="Footer_Bootem">
               <ul className="Footer_Bootem_line">
                  ...
                  <li><img className="Footer_Bootem_lineImg" src="https://static-assets-web.flixcart.com/www/linchpin/fk-cp-zion/img/payment-method_69e7ec.svg" alt="Secure Payment" /></li>
               </ul>
            </div>
         </div>
      </>
